    ...
    <div className="flex justify-between items-center 2xl:px-12 xl:px-20 md:px-10 md:h-2/3 2xl:h-[75%] border-b bg-white">
      ...
      <div className="flex items-center h-full md:w-full 2xl:w-[55%] lg:w-[65%]">
        ...
        <div className="flex items-center 2xl:space-x-20 xl:space-x-12 lg:space-x-5 md:space-x-6 2xl:text-3xl xl:text-base lg:text-sm md:text-xs font-semibold">
          <Link href="/home"><p className="text-black hover:text-teal-900 rounded-md font-extrabold underline">Services</p></Link>
          <Link href="/home"><p className="text-black hover:text-teal-900 rounded-md font-extrabold underline">Location</p></Link>
          <Link href="/home"><p  className="text-black hover:text-teal-900 rounded-md font-extrabold underline">Insurance</p></Link>
          <Link href="/home"><p className="text-black hover:text-teal-900 rounded-md font-extrabold underline">About</p></Link>
          <Link href="/home"><p className="text-black hover:text-teal-900 rounded-md font-extrabold underline">Contact</p></Link>
